    ...
    var me = {
        ...
        tpl: ''.concat(
            '<div class="js-timer">',
                ...
                '<div class="buttons">',
                    ...
                    '<button id="btn-reset"><span class="shortcut">R</span>eset</button>',
                    '<div class="btn-set-wrapper">',
                    '<button id="btn-set">Set to:</button>',
                    '<input type="text" placeholder="Enter time in minutes" name="time" id="timer-value" accesskey="i" />',
                    '</div>',
                '</div>',
                '<audio id="beep">',
        ...
        */
        ...
        shout: function shout(msg) {
            ...
            intervalId = setInterval(toggleBackground, 75);
         ...
         * showMessage
         *
         * TODO implement jquery UI for displaying this message
         *
